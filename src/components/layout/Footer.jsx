      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-brand-white/60 font-sans text-sm font-light leading-relaxed max-w-sm mb-6">
            ...
            <a 
              href="https://wa.me/919771455363?text=Hi%20TONI&GUY%20Patna,%20I%20would%20like%20to%20know%20more%20about%20your%20services." 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 text-xs uppercase tracking-widest bg-brand-gold/10 text-brand-gold border border-brand-gold/30 px-4 py-2.5 rounded-sm hover:bg-brand-gold hover:text-brand-charcoal transition-all w-max font-semibold"
            >
          ...
          <div className="flex flex-col">
            <h4 className="text-brand-white font-sans text-sm uppercase tracking-widest mb-6 font-semibold">Explore</h4>
            <ul className="space-y-3 font-sans text-sm font-light text-brand-white/70">
              <li>
              ...
              <li>
                <Link to="/booking" className="hover:text-brand-gold transition-colors">Book Appointment</Link>
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://www.instagram.com/toniandguyunisex?utm_source=qr&igsh=MWR2NmdmZ3dpYzJjeg%3D%3D" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-brand-white/20 flex items-center justify-center text-brand-white hover:border-brand-gold hover:text-brand-gold transition-colors">
              ...
              <a href="https://www.facebook.com/share/1HbkS5xhtC/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-brand-white/20 flex items-center justify-center text-brand-white hover:border-brand-gold hover:text-brand-gold transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
