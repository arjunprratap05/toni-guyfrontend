...
// 1. COMPLETE EXPORTABLE MENU DATA
export const servicesMenu = [
  ...
  { id: 'h_mens_pack', category: 'Hair Cut & Styling', name: 'Mens Styling Package', price: 550, duration: '45 Min', description: 'Complete grooming package with Shampoo & Conditioner.' },
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] w-full pb-24 font-sans text-white">
      ...
      {/* 3. CATEGORY SELECTION (Visible wrap pills + Mobile Dropdown combo) */}
      <section className="max-w-[1200px] mx-auto px-6 mb-12">
        ...
        {/* Desktop / Tablet Wrap Filter Pills */}
      ...
      <section className="max-w-[1200px] mx-auto px-6 mt-16 text-center">
        <p className="text-gray-500 text-xs tracking-widest uppercase pb-6 border-t border-white/10 pt-8">
          Note: All Final Prices displayed include applicable 5% Goods and Services Tax (GST).
        </p>
      </section>
